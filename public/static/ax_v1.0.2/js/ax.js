...
$(document).ready(function () {
    ...
    $(".ax-box").each(function(){
        var panel = $(this);
        var closeBtn = panel.find('.ax-box-close');
        var headerDiv = panel.find('.ax-box-header');
        if(headerDiv.find(".ax-des").length>0){
            if(headerDiv.find(".ax-des").html() == ''){
        ...
        closeBtn.click(function(){
            if(panel.find('.ax-box-body').is(':visible')==false){
                closeBtn.removeClass('ax-rotate-180');
                panel.find('.ax-box-body').slideDown(200);
            }else{
                closeBtn.addClass('ax-rotate-180');
                panel.find('.ax-box-body').slideUp(200);
            }
        });
    });
    //window close
