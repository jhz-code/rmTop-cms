...
//内页导航
	$(window).scroll(function(){
		if($(window).scrollTop()>0){
			...
			// $('.ml-nav').find(".ml-logo img").attr("src","images/logo1.png");
			$('.ml-nav').find(" li div").css("background","#333")
		}
		else {
			$('.ml-nav').removeClass("curr");
			$(".header-top").css({'display':'block'});
			// $('.ml-nav').find(".ml-logo img").attr("src","images/logo.png");
			$('.ml-nav').find(" li div").css("background","#333")
		}
	})
	...
	$(window).scroll(function(){
		if($(window).scrollTop()>0){
			...
			$(".header-top").css({'display':'none'});
			// $('.ml-nav1').find(".ml-logo img").attr("src","images/logo1.png");
			$('.ml-nav1').find(" li div").css("background","#333")
		}
		else {
